...
abstract class ListPreferenceData(private val preference: com.luteapp.alarmio.data.PreferenceData, private val title: Int) : BasePreferenceData<ListPreferenceData.ViewHolder>() {
