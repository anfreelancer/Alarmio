 ...
 */
class BooleanPreferenceData(private val preference: com.luteapp.alarmio.data.PreferenceData, @StringRes private val title: Int, @StringRes private val description: Int) : BasePreferenceData<BooleanPreferenceData.ViewHolder>() {
