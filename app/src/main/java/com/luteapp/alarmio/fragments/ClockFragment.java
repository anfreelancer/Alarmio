...
import com.luteapp.alarmio.views.DigitalClockView;

public class ClockFragment extends BasePagerFragment {

    public static final String EXTRA_TIME_ZONE = "com.luteapp.alarmio.fragments.ClockFragment.EXTRA_TIME_ZONE";
