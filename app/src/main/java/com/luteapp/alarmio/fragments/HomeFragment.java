...
import com.luteapp.alarmio.ShopActivity;
...
import com.luteapp.alarmio.adapters.SimplePagerAdapter;
import com.luteapp.alarmio.dialogs.AestheticTimeSheetPickerDialog;
import com.luteapp.alarmio.dialogs.TimerDialog;
import com.luteapp.alarmio.interfaces.FragmentInstantiator;
import com.luteapp.alarmio.utils.ImageUtils;
import com.luteapp.alarmio.views.PageIndicatorView;
...
public class HomeFragment extends BaseFragment {
    ...
    public static final String INTENT_ACTION = "com.luteapp.alarmio.HomeFragment.INTENT_ACTION";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        premiumFab = view.findViewById(R.id.premiumFab);
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                if (tab.getPosition() > 0) {
                    if (!BillingClientSetup.isUpgraded(getContext())) return;
        ...
        textColorPrimarySubscription = Aesthetic.Companion.get()
                ...
                .subscribe(integer -> {
                    ...
                    premiumFab.setTitleTextColor(integer);
                });
        ...
        textColorPrimaryInverseSubscription = Aesthetic.Companion.get()
                ...
                .subscribe(integer -> {
                    ...
                    premiumFab.setTitleBackgroundColor(integer);
                });
        ...
        premiumFab.setOnClickListener(view -> {
