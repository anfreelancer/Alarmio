package com.luteapp.alarmio.fragments;
...
import com.luteapp.alarmio.BillingClientSetup;
import com.luteapp.alarmio.data.PreferenceData;
import com.luteapp.alarmio.data.preference.AboutPreferenceData;
import com.luteapp.alarmio.data.preference.AlertWindowPreferenceData;
import com.luteapp.alarmio.data.preference.BatteryOptimizationPreferenceData;
import com.luteapp.alarmio.data.preference.BooleanPreferenceData;
import com.luteapp.alarmio.data.preference.ImageFilePreferenceData;
import com.luteapp.alarmio.data.preference.RingtonePreferenceData;
import com.luteapp.alarmio.data.preference.ThemePreferenceData;
import com.luteapp.alarmio.data.preference.TimePreferenceData;
import com.luteapp.alarmio.data.preference.TimeZonesPreferenceData;
...
import com.luteapp.alarmio.adapters.PreferenceAdapter;

import com.luteapp.alarmio.data.preference.AboutPreferenceData;
import com.luteapp.alarmio.data.preference.AlertWindowPreferenceData;
import com.luteapp.alarmio.data.preference.BasePreferenceData;
import com.luteapp.alarmio.data.preference.BatteryOptimizationPreferenceData;
import com.luteapp.alarmio.data.preference.BooleanPreferenceData;
import com.luteapp.alarmio.data.preference.CustomPreferenceData;
import com.luteapp.alarmio.data.preference.ImageFilePreferenceData;
import com.luteapp.alarmio.data.preference.RingtonePreferenceData;
import com.luteapp.alarmio.data.preference.ThemePreferenceData;
import com.luteapp.alarmio.data.preference.TimePreferenceData;
import com.luteapp.alarmio.data.preference.TimeZonesPreferenceData;
import com.luteapp.alarmio.interfaces.ContextFragmentInstantiator;
...
public class SettingsFragment extends BasePagerFragment implements Consumer {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (BillingClientSetup.isUpgraded(getContext())){
